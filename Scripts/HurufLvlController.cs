...
{
    public class HurufLvlController : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            Debug.Log(PlayerPrefs.GetInt("HurufLvl1Star"));
        }
        ...
        void controlInteractableButton()
        {
            ...
            if (PlayerPrefs.GetInt("HurufLvl1") == 1)
            {
                lvl1Btn.GetComponent<Button>().interactable = true;
            } 
            if (PlayerPrefs.GetInt("HurufLvl2") == 1)
            {
                lvl2Btn.GetComponent<Button>().interactable = true;
            }
            if (PlayerPrefs.GetInt("HurufLvl3") == 1)
            {
        ...
        void setStarByPlayerPrefs()
        {
            ...
            for (int i = 1; i < 4; i++)
            {
                ...
                setActiveStar(PlayerPrefs.GetInt("HurufLvl" + i + "Star"), DummyBtn);
            }
        }
