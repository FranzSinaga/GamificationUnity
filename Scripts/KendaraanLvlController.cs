...
{
    public class KendaraanLvlController : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            Debug.Log(PlayerPrefs.GetInt("KendaraanLvl1Star"));
        }
        ...
        void controlInteractableButton()
        {
            ...
            if (PlayerPrefs.GetInt("KendaraanLvl1") == 1)
            {
                lvl1Btn.GetComponent<Button>().interactable = true;
            } 
            if (PlayerPrefs.GetInt("KendaraanLvl2") == 1)
            {
                lvl2Btn.GetComponent<Button>().interactable = true;
            }
            if (PlayerPrefs.GetInt("KendaraanLvl3") == 1)
            {
        ...
        void setStarByPlayerPrefs()
        {
            ...
            for (int i = 1; i < 4; i++)
            {
                ...
                setActiveStar(PlayerPrefs.GetInt("KendaraanLvl" + i + "Star"), DummyBtn);
            }
        }
